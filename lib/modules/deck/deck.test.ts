...
import { diffSaved, isEmptyDiff, layersFrom, type Saved } from "./assemble";
...
describe("Susun & simpan state Presentasi", () => {
  it("prioritas manual > raw/auto > excel; auto tidak menimpa raw", () => {
    const l = layersFrom([
      { month: "2026-08", key: "sales", source: "excel", value: 1 },
      { month: "2026-08", key: "sales", source: "raw", value: 2 },
    ...
    expect(l.raw).toEqual({ open: { "2026-09": 7 }, sales: { "2026-08": 2 }, "coll_tgt:0": { "2026-08": 5, "2026-09": 11 } });
    expect(l.manual).toEqual({ "coll_tgt:0": { "2026-08": 9 } });
    expect(l.excel).toEqual({ sales: { "2026-08": 1 } });
  });
